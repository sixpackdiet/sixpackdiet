		...
		<table border=1>
			...
			<c:forEach items="${foodItems}" var="foodItem">
				<tr>
					...
					<td>${foodItem.fat}</td>
					<td><img alt="Delete Food Item" style="width: 16px; height: 16px"
						src="<c:url value="/resources/css/images/delete.jpg"/>"
						onClick="submitForm(${foodItem.id})" /></td>
				</tr>
			</c:forEach>
		</table>
	</form>
	<a href="showFoodCalories">See Calories Consumed Here</a>
</body>
</html>